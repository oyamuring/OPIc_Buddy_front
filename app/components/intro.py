...
def show_intro():
    ...
    <div class="block-welcome" style='text-align: center;'>
        <h2 class="opic-header">
            <span class="opic-header-en opic-header-en-desktop">🔊 Oral Proficiency Interview - computer (OPIc)</span>
            <span class="opic-header-en opic-header-en-mobile">🔊 Oral Proficiency Interview<br>computer (OPIc)</span>
        </h2>
